...
const NEWS_URL = "https://www.toyorobot.com/News/Msg";
...
const FEATURED_NEWS = {
  date: NEWS_UPDATED,
  badge: "News",
  title: "HSF Automation and Yamaha Motor Establish Joint Venture — TY ROBOTICS Co., Ltd.",
  subtitle: "【NEWS RELEASE】",
  link: "https://global.yamaha-motor.com/news/2025/1014/ty.html",
  paragraphs: [
    "HSF Automation and Yamaha Motor Establish Joint Venture — TY ROBOTICS Co., Ltd. Integrating production and sharing resources to strengthen industrial robot competitiveness",
    "HSF Automation Co., Ltd. (“HSF Automation”) and Yamaha Motor Co., Ltd. (Tokyo: 7272; “Yamaha Motor”) are pleased to announce the establishment of a new joint venture company, TY ROBOTICS Co., Ltd. (“TY”), in August 2025.",
    ...
    "Since Yamaha Motor’s capital investment in HSF Automation in March 2019, both companies have maintained a strong collaborative partnership — including OEM supply of selected robot models and joint development of next-generation products.",
    ...
    "For decades, HSF Automation has been dedicated to the R&D and manufacturing of Cartesian robots and linear motion modules for industrial automation.",
    "With continuous global growth in semiconductor, smartphone, and factory automation sectors, HSF has expanded its presence with sales subsidiaries in China, the U.S., India, Vietnam, Thailand, Japan, and South Korea, and manufacturing bases in China, Japan, and South Korea — ranking among the top three global manufacturers of linear motion modules.",
    "Building on over a decade of expertise in linear motion design and production, HSF is also developing a new linear motion actuator (“the muscle”) for humanoid robot arms and legs — aiming to play a vital role in the rapidly growing humanoid robotics industry.",
  ],
};

const PAST_NEWS: { date: string; type: string; title: string }[] = [
  { date: "2023/11/09", type: "News", title: "【Exhibition】 「HSF Robotics Korea」" },
  { date: "2023/02/26", type: "News", title: "東佑達 單軸機器人 助攻自動化" },
  { date: "2022/08/26", type: "News", title: "【自動化展】東佑達奈米系統公司參展 首推精密氣浮單軸平台" },
  { date: "2022/06/23", type: "News", title: "HSF Xinji plant 2 Groundbreaking Ceremony" },
